<?php
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            (t.status IN('Pending','Rejected - I')) AND (CURDATE() =DATE(s.randomized_time) OR CURDATE() = DATE(t.test_time))
            AND t.Test_ID = s.id";
            ...
            while($staff = $result->fetch_assoc()){
                ...
                else if($staff['Status'] == 'Rejected - I'){
                    echo "<td style='color:red;'>".$staff['Status']."</td>";
                }
                else if($staff['Status'] == 'Rejected - II'){
                    echo "<td style='color:red;'>".$staff['Status']."</td>";
                }
                echo "</tr>";
            } 
