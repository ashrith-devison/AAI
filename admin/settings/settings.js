...
function records_init(){
    ...
    <form action="">
            ...
            <input class = 'form-control' style='margin-top:4px;' id='fetch-record-data' onchange='fetch_result_date()' type='date'>
    </form>`;
    $('#request-table').hide();
    $('#request-table').html('');
...
function fetch_result_date(){
    ...
    const user_data = {
        ...
        fromDate : document.getElementById('fetch-record-data').value,
        toDate : '2024-09-21'
    };
